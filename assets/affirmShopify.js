...
<!-- Affirm -->
	...
	let parsedRegionPublicKeys = JSON.parse('{"US":"0JZNBYTELVUA7Y4K","CA":null}');

	if (_shopify_country === 'US') {
		_affirm_country = 'USA';
		_affirm_locale = 'en_US';
		_region_public_key = '0JZNBYTELVUA7Y4K'
...
let promosJSON = '[{"promoStatus":true,"saleSelector":"","logoColor":"blue","comparePrices":false,"dataElement":".product-single__form","logoType":"logo","addCents":false,"selector":"","fontSize":"13","pageType":"product","shopifyPageType":"","position":"beforeend","onChange":"","alaElement":".product-block.product-block--price"},{"promoStatus":true,"saleSelector":"","logoColor":"blue","comparePrices":false,"dataElement":"","logoType":"logo","addCents":false,"selector":".grid-product__price","fontSize":"13","position":"beforeend","shopifyPageType":"collections","pageType":"category","onChange":"","alaElement":""},{"promoStatus":true,"saleSelector":"","logoColor":"blue","comparePrices":false,"dataElement":null,"logoType":"symbol","addCents":false,"selector":".cart__item-sub.cart__item-row","fontSize":"12","pageType":"cart","shopifyPageType":"cart​","position":"afterend","onChange":null,"alaElement":""}]';
